...
<?php
session_start();
$query = "SELECT Ref_ID,Name,Publication,Edition from items order by Ref_ID asc";
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                ...
                while($row = mysqli_fetch_assoc($result)) {
                    ...
                    <br>
                    <fieldset>
                <li><h3><?php echo "Book ID:" . " " . $row["Ref_ID"] . " " . $row["Name"] . " Published by" . " " . $row["Publication"] . " ...Edition:" . " " . $row["Edition"]; ?></h3></li>
                </fieldset>
                <?php
            }
            ?>
