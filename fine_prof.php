...
<head>
    ...
    <title>Status of the Book</title>
...
<fieldset id="main"><legend>Fine Amount for Professors</legend>
<form action="finelog_prof.php" method="post">
<label>Professor ID:</label>
<input type="text" name="profid">
<br>
<br>
<input type="submit" value="Fine Amount"/>
</form>
